...
public class GetBooksByStatusHandler : IRequestHandler<GetBooksByStatusQuery, IEnumerable<BookDto>>
{
    private readonly IAppDbContext _context;

    public GetBooksByStatusHandler(IAppDbContext context)
    {
        _context = context;
    }

    public async Task<IEnumerable<BookDto>> Handle(GetBooksByStatusQuery request, CancellationToken cancellationToken)
    {
